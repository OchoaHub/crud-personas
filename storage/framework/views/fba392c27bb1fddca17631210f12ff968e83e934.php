...
<body>
  <div class="container mt-2">
    <div class="row">
      <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
          <a class="btn btn-primary" href="<?php echo e(route('names.index')); ?>"> Back</a>
        </div>
      </div>
    </div>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('names.store')); ?>" method="POST" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
      <div class="row">
...
</html><?php /**PATH /Users/jochoa/workspace/crud-personas/resources/views/names/create.blade.php ENDPATH**/ ?>